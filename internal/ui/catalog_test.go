...
// The console fixture is generated by marshaling store.BenchCatalogEntry — the
// deployed GET /v1/bench/catalog wire type (#592, hk f0681e5). This test pins
// that: the committed fixture must round-trip through the real Go type with no
// field loss, and it must exercise the states the screen renders (a retired
